package ProgressTheSpire.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import ProgressTheSpire.ProgressTheSpire;
import ProgressTheSpire.util.CardStats;
import ProgressTheSpire.util.TriFunction;
...
import static ProgressTheSpire.util.GeneralUtils.removePrefix;
import static ProgressTheSpire.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return ProgressTheSpire.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    ProgressTheSpire.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
